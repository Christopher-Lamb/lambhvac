...
function Carousel({ className, height = "400px", bgColor = "bg-white", displayArray = items, interval = true, intervalTime = 800000 }) {
  ...
  return (
    <div ref={containerRef} className="h-[600px] select-none w-full" style={{ height }}>
      <div className="relative w-full h-full">
        <div className="carousel-btns absolute h-full w-full flex items-center justify-between">
          <div className={"h-full flex items-center w-fit z-[1] car-arrow-cont"}>
          ...
          {stateArr.map((position, i) => {
            ...
            return (
              ...
              <div
                ...
                className={`relative row-start-1 w-full h-full snap-center flex items-center justify-center ${colors[colorPos]} ${bgColor} ${className} text-white`}
              >
                {/* {position} */}
                <div className="w-full bg-blackx h-full grid grid-cols-3 px-32">
                  ...
                  <div className="bg-white w-full text-black text-center pt-8 border">{displayArray[position]}</div>
                  <div className="bg-white w-full text-black text-center pt-8 border">{displayArray[position]}</div>
                </div>
              </div>
            );
